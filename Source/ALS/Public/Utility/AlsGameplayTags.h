...
namespace AlsLocomotionModeTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Falling)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Flying)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Swimming)
}

namespace AlsFlightModeTags
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Hovering)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Aerial)
}
