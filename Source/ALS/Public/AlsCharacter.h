...
public:
	...
	const FAlsFlightState& GetFlightState() const			{ return FlightState; }
	const FAlsRagdollingState& GetRagdollingState() const	{ return RagdollingState; }

	const UAlsCharacterSettings* GetSettings() const { return Settings; }
